...
```
The above bar graph explains the distribution of price levels across the all categories of the furniture. Tb&d, chrs and B&su have more number of furnitures who are in '0' price level and sf&a has highest numer of furnitures who are in '1' price level.
```{r exploratory ,echo = FALSE, eval = TRUE}
library(plotly)
...
The above graphs help more clearly to understand the probability of price over 1000 vs individual parameters: depth, height, and weight. According to the probability of price over 1000 vs depth graph depth more than 200 the probability of price over 1000 is constant meanwhile relationship between the probability of price over 1000 and height is moderately linear.
